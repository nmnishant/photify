...
exports.urlOptions = exports.imgSize = exports.api_key = void 0;
var urlOptions = {
...
var buildFlickrURL = function buildFlickrURL(_ref) {
  ...
  var getPhotosURL = "https://www.flickr.com/services/rest?";
  Object.entries(params).forEach(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
        key = _ref3[0],
        value = _ref3[1];

    getPhotosURL += "".concat(key, "=").concat(value, "&");
  });
  getPhotosURL = getPhotosURL.slice(0, -1);
  return getPhotosURL;
};

var _default = buildFlickrURL;
exports.default = _default;
},{"./config":"config.js"}],"Error.js":[function(require,module,exports) {
"use strict";
...
var showError = function showError(msg) {
  var images = document.querySelector(".images-container").children;
...
},{}],"addPhotosToDOM.js":[function(require,module,exports) {
"use strict";
...
var addPhotosToDOM = function addPhotosToDOM(photosArr, size) {
  if (photosArr.length == 0) (0, _Error.showError)();else (0, _Error.hideError)();
  photosArr.forEach(function (photo) {
    return imageContainer.insertAdjacentHTML("beforeend", "<img class=\"photo\" src=\"https://live.staticflickr.com/".concat(photo.server, "/").concat(photo.id, "_").concat(photo.secret, "_").concat(size, ".jpg\" alt=\"").concat(photo.title, "\">"));
  });
};

var _default = addPhotosToDOM;
exports.default = _default;
},{"./Error":"Error.js"}],"loadPage.js":[function(require,module,exports) {
"use strict";
...
var _addPhotosToDOM = _interopRequireDefault(require("./addPhotosToDOM"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            photosRes = _context.sent;
            _context.next = 6;
            return photosRes.json();

          case 6:
            photosJSON = _context.sent;

            if (!(photosJSON.stat == "fail")) {
              _context.next = 9;
              break;
            }

            throw new Error(photosJSON.message);

          case 9:
            (0, _addPhotosToDOM.default)(photosJSON.photos.photo, _config.imgSize); // w - size suffix (means 400px max)
...
var loadPage = function loadPage(url, pageNo) {
  if (pageNo) url += "&page=".concat(pageNo);
  getPhotos(url);
};

var _default = loadPage;
exports.default = _default;
},{"./addPhotosToDOM":"addPhotosToDOM.js","./config":"config.js","./Error":"Error.js"}],"loadAutoComplete.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var autoComp = document.querySelector(".auto-comp");
var searchField = document.querySelector(".search-field"); ///////////////////////////////
// Load auto complete element from browser local storage

var loadAutoComplete = function loadAutoComplete() {
  autoComp.classList.remove("hide");
  autoComp.innerHTML = "";
  var searchHistory = JSON.parse(localStorage.getItem("searchHistory") || "[]");

  for (var i = 0; i < searchHistory.length && i < 5; i++) {
    autoComp.insertAdjacentHTML("beforeend", "<div data-item=\"".concat(i, "\" class=\"item\">\n        <li class=\"list-item\">").concat(searchHistory[searchHistory.length - 1 - i], "</li>\n        <i class=\"im im-x-mark delete-search\"></i>\n      </div>"));
  }
};

var _default = loadAutoComplete;
exports.default = _default;
...
var _buildFlickrURL = _interopRequireDefault(require("./buildFlickrURL"));

var _loadPage = _interopRequireDefault(require("./loadPage"));

var _config = require("./config");

var _loadAutoComplete = _interopRequireDefault(require("./loadAutoComplete"));
...
var autoComp = document.querySelector(".auto-comp");
var loader = document.querySelector(".loader");
var clearSearchFieldBtn = document.querySelector(".cross");
var searchIcon = document.querySelector(".magnifier");
...
var loadPhotos = function loadPhotos(_ref) {
  var _ref2 = _slicedToArray(_ref, 1),
      entry = _ref2[0];

  if (entry.isIntersecting) {
    (0, _Error.hideError)();
    var url = (0, _buildFlickrURL.default)(_config.urlOptions);
    (0, _loadPage.default)(url);
    _config.urlOptions.page++;
  }
};

var loadObserver = new IntersectionObserver(loadPhotos, {
  root: null,
  threshold: 0.5
});
...
var stickyNav = function stickyNav(_ref3) {
...
var pageObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0
});
...
var LoadImagesByText = function LoadImagesByText(searchText) {
  _config.urlOptions.method = "flickr.photos.search";
  _config.urlOptions.page = 1;
  _config.urlOptions.options = {};
  storeSearchHistory(searchText);
  if (!searchText) _config.urlOptions.method = "flickr.photos.getRecent";else _config.urlOptions.options = {
    text: searchText
  };
...
var storeSearchHistory = function storeSearchHistory(val) {
  if (!val) return;
...
var deleteSearch = function deleteSearch(index) {
  var searchHistory = JSON.parse(localStorage.getItem("searchHistory"));
  searchHistory = searchHistory.filter(function (_, i) {
    return index != searchHistory.length - 1 - i;
  });
  localStorage.setItem("searchHistory", JSON.stringify(searchHistory));
  (0, _loadAutoComplete.default)();
}; ///////////////////////////////////////
...
autoComp.addEventListener("click", function (e) {
...
document.body.addEventListener("click", function (e) {
  ...
  if (!search && !e.target.classList.contains("delete-search")) autoComp.classList.add("hide");
...
clearSearchFieldBtn.addEventListener("click", function () {
  return searchField.value = "";
}); // 2. Load auto complete element from local storage

searchField.addEventListener("click", _loadAutoComplete.default); // 3. Load images of typed text

searchIcon.addEventListener("click", function () {
  return LoadImagesByText(searchField.value);
